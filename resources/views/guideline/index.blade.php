<x-layout>
    <x-slot name="title">Pedoman</x-slot>
    @if ($errors->any())
                    ...
                    <div class="collapse mb-5" id="collapseExample">
                        <div class="p-3 border rounded">
                            ...
                            <form action="{{ Route('guideline.update', $guideline->id) }}" method="post">
                                ...
                                @method('PUT')
                                <div class="mb-3">
                                    <label for="description" class="form-label">Pedoman</label>
                                    <textarea class="form-control" name="description" value="" id="editor" rows="3">{{ $guideline->description }}</textarea>
                                    @error('description')
